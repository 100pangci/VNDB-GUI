...
- **双列布局** — 左侧「原版发行」显示非中文版本，右侧「汉化版」显示中文版本
- **智能预览** — 原版发行提供开发商/发售日期/平台/语言信息；汉化版提供汉化组/补丁日期信息
- **文件名生成** — 自动生成标准格式文件名：
  ```
...
[Yuzusoft][20161014]千恋＊万花[v19073][Windows][SiglusKey][CHS]
```
...
3. **选择汉化版** — 在右侧列表选择对应的汉化版本（汉化组/补丁日期/语言自动填入）
